...
<div id="updatePicture-panel">
	<div class="bd" style="padding:10px 10px;background-color:white">
		<form method="post" id="update-picture-form" action="index.cfm?event=updatePicture" enctype="multipart/form-data" style="display:none;hidden:true">
			...
			<button type="submit"><label class="uploadbttn">Upload</label></button>
			<br><br>
		</form>
	</div>
</div>
